...
namespace ann {
    ...
    void neuralnet::evaluate_nonrecurrent(const std::vector<double>& input, std::vector<double>& output) {
    ...
    void neuralnet::evaluate_recurrent(const std::vector<double>& input, std::vector<double>& output){
    ...
    void neuralnet::evaluate(const std::vector<double>& input, std::vector<double>& output){
        if (recurrent)
    ...
    void neuralnet::import_fromfile(std::string filename){
        std::ifstream o;
        o.open(filename);
    ...
    void neuralnet::export_tofile(std::string filename){
        std::ofstream o;
        o.open(filename);
